package com.amrg.herafi.ui.screens.language_screen
...
import com.amrg.herafi.ui.components.RectangularRadioButton
...
private fun ContentColumn(viewModel: LanguageViewModel) {
    Column(
        ...
        RectangularRadioButton(
            ...
            painter = painterResource(id = R.drawable.ic_flag_egypt),
            isSelected = viewModel.isArabic.value
        ) {
